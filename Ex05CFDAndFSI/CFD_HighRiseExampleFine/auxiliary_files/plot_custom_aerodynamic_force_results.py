...
file2read = "Drag_structure_custom_drag.dat" # file name of the drag results
...
plt.savefig('fig_' + file2read + '.png',bbox_inches='tight', dpi=300)
plt.savefig('fig_' + file2read + '.pdf',bbox_inches='tight', dpi=300)
plt.savefig('fig_' + file2read + '.svg',bbox_inches='tight')

...
def blue4pressure(series, n_blocks, P1 = 0.8, P2 = 0.5704, dur_ratio=1):
    '''
    ...
    n_blocks = number of epochs (integer)of series data, 4 <= n <= 100
    ...
    return(p1_max, p2_max, p1_rmax, p2_rmax, u_max, b_max, series_max, p1_min, p2_min, p1_rmin, p2_rmin, u_min, b_min, series_min)
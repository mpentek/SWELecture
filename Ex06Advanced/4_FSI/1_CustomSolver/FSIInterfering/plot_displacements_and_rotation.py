...
with open("ProjectParametersCSD2.json") as parameter_file:
    project_parameters = json.load(parameter_file)

file_disp_x_vec_res   = "sdof_" + project_parameters["problem_data"]["problem_name"].lower() + "_"+ project_parameters["model_data"]["dof_type"][0].lower() + ".dat" 
file_disp_y_vec_res   = "sdof_" + project_parameters["problem_data"]["problem_name"].lower() + "_"+ project_parameters["model_data"]["dof_type"][1].lower() + ".dat" 
file_rot_vec_res     = "sdof_" + project_parameters["problem_data"]["problem_name"].lower() + "_"+ project_parameters["model_data"]["dof_type"][2].lower() + ".dat" 
...
plt.plot(time_dx_vr, disp_x_vr, 'b-', linewidth=lw, label='Displacement vecRes')
...
plt.plot(time_dy_vr, disp_y_vr, 'b-', linewidth=lw, label='Displacement vecRes')

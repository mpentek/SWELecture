...
file2read = "sdof_" + project_parameters["problem_data"]["problem_name"].lower(
) + "_" + project_parameters["model_data"]["dof_type"].lower() + ".dat"
# ======================================================
...
# set up the plot
fig = plt.figure()
ax = plt.axes(xlim=(min(simul_time), max(simul_time)),
              ylim=(min(time_data), max(time_data)))
line, = ax.plot([], [], lw=2)

...
file_writer = other_utilities.FileWriter("generic_fsi.dat", ["Time", "Disp_X", "Disp_Y", "Disp_Z", "Coupling_Iterations"])
point_of_interest = KratosMultiphysics.Point(15.0,190.0, 0.0) # the point where displacements are traced over time

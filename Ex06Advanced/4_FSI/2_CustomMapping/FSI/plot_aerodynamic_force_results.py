...
# file name of the drag results
file2read = "FluidModelPart.Drag_InterfaceFluid_drag.dat"
...
plt.plot(simulTime, forceX, 'b-', linewidth=lw,
         label='Aerodyn. Force X without Ramp')
plt.plot(simulTime, forceY, 'r-', linewidth=lw,
         label='Aerodyn. Force Y without Ramp')
plt.plot(simulTime, forceZ, 'g-', linewidth=lw,

...
class CoSimulationBaseSolver(object):
    ...
    def InitializeIO(self, solvers, io_echo_level):
        ...
        if self.io_is_initialized:
            raise Exception('IO for "' + solver_name +
    ...
    def AdvanceInTime(self, current_time):
        # needed if this solver is used as dummy
        return current_time + self.cosim_solver_settings["time_step"]
    ...
    def GetBufferSize(self):
        raise Exception(
            '"GetBufferSize" function must be implemented in derived class!')

    def GetDeltaTime(self):
        raise Exception(
            '"GetDeltaTime" function must be implemented in derived class!')
    ...
    def _GetIOName(self):
        raise Exception(
            '"_GetIOName" function must be implemented in derived class!')
